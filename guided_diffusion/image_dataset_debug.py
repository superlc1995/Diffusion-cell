...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        cr_im, cr_ann, cr_copu = random_crop(pil_im, pil_ann,pil_copu, 512, 512)
        ...
        return torch.cat((cr_ann, cr_copu), dim = 0),  img_path, ann_path, copu_path

def random_crop(imaged, annd, copula,crop_width, crop_height):
    """
    ...
    return cropped_image, cropped_ann, cropped_copu